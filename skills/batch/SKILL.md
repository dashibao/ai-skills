...
The user will provide an instruction describing the batch change they want to make.
...
- Must be a git repository (batch uses git worktrees)
- Provide an instruction describing the batch change
